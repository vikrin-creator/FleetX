  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        'div',
        null,
        React.createElement('h2', { className: 'mt-6 text-center text-2xl sm:text-3xl font-bold text-gray-900' }, 'Sign in to your account'),
        React.createElement(
          'p',
          { className: 'mt-2 text-center text-sm text-gray-600' },
          'Or ',
          React.createElement(Link, { to: '/signup', className: 'font-medium text-blue-600 hover:text-blue-500' }, 'create a new account')
        )
      ),
      React.createElement(
        'form',
